  ...
  return (
    <div className="container mx-auto px-4 py-20 pb-32 bg-[#EDE8E0]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-8 relative">
        ...
        <div className="hidden lg:block absolute left-0 top-0 h-full" style={{ transform: 'translateX(-70%)' }}>
        ...
        <div className="hidden lg:block absolute right-0 top-0 h-full" style={{ transform: 'translateX(70%)' }}>
          <img 
