...
const formSchema = z.object({
  ...
  drawingDataUrl: z.string().optional(),
});
...
export function DiagramForm({ onSubmit, isGenerating, suggestions }: DiagramFormProps) {
  ...
  const handleDrawingComplete = (drawingDataUrl: string) => {
    form.setValue("drawingDataUrl", drawingDataUrl);
    form.setValue("type", "generate");
        ...
        {showDrawing ? (
          ...
          <>
            ...
            <Button
              ...
              className="w-full"
            >
              Dessiner un schéma à main levée
            </Button>
